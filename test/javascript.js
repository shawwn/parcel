...
describe('javascript', function() {
  it('should produce a basic JS bundle with CommonJS requires', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/commonjs/index.js');
  ...
  it('should produce a basic JS bundle with ES6 imports', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/es6/index.js');
  ...
  it('should split bundles when a dynamic import is used', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/dynamic/index.js');
  ...
  it('should support requiring JSON files', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/json/index.js');
  ...
  it('should minify JS in production mode', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/uglify/index.js', {
      production: true
    });
  ...
  it('should insert global variables when needed', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/globals/index.js');
  ...
  it('should insert environment variables', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/env/index.js');
  ...
  it('should support requiring YAML files', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/yaml/index.js');
  ...
  it('should support requiring CoffeeScript files', async function() {
    let {b, fs} = await bundling(__dirname + '/integration/coffee/index.js');
